    ...
    return (
      ...
      >
        ...
        >
          ...
          <Dropdown.Item onClick={() => handleSelect("Name")}>
            Name
          </Dropdown.Item>
          <Dropdown.Item onClick={() => handleSelect("Category")}>
            Category
          </Dropdown.Item>
          <Dropdown.Item onClick={() => handleSelect("Platform")}>
            Platform
          </Dropdown.Item>
          <Dropdown.Item onClick={() => handleSelect("Accessibility")}>
            Accessibility
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
          ...
          {[...Array(Math.ceil(games.length / gamesPerPage)).keys()].map(
            (number) => (
              <button
                ...
                className={`px-4 py-2 mx-1 ${currentPage === number + 1
